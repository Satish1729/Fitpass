...
class Workouts: NSObject {
    ...
    func updateWorkouts(responseDict : NSDictionary?) -> NSMutableArray {
        ...
        for workoutObj in (dataArray as? [[String:Any]])! {
            ...
            workoutBean.is_active = workoutObj["is_active"] as? String
            ...
            workoutBean.workout_id = workoutObj["workout_id"] as? String
            ...
            for studioObj in (workoutSchedulesArray as? [[String:Any]])! {
                ...
                workoutScheduleBean.number_of_seats = studioObj["number_of_seats"] as? String
                ...
                workoutScheduleBean.workout_id = studioObj["workout_id"] as? String
                workoutScheduleBean.workout_schedule_id = studioObj["workout_schedule_id"] as? String
